...
const STATUS_COLORS: Record<string, string> = {
  Lead: "#0891b2", Proposal: "#d97706", "Demo Booked": "#0d9488", "Demo Conducted": "#ea580c",
  "Demo Completed": "#f59e0b", "Waiting on Roster": "#8b5cf6",
  Won: "#16a34a", Paused: "#7c3aed", Churned: "#94a3b8",
};
const STATUSES = ["Lead", "Proposal", "Demo Booked", "Demo Conducted", "Demo Completed", "Waiting on Roster", "Won", "Paused", "Churned"];
