      ...
      <div className="bg-primary text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <InlineEditField ownerId={ownerId} listingType="ebook" listingId={item.id} field="name" value={item.name} tag="h1" className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-primary uppercase leading-tight tracking-tight" />
              {item.tagline && (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Events */}
            <ListingEventsSection listingType="ebook" listingId={item.id} listingSlug={slug} ownerId={ownerId} />
