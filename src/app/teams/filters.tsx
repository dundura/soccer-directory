                  ...
                  {featuredTeams.map((team) => (
                    <ListingCard
                      ...
                      badges={[
                        ...
                        ...(team.guestPlayersWelcome ? [{ label: "Guest Players", variant: "orange" as const }] : []),
                      ]}
                      details={[
              ...
              {visibleNonFeatured.map((team) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Image thumbnail */}
                    <div className="w-24 sm:w-32 md:w-40 self-stretch flex-shrink-0 bg-surface flex items-center justify-center overflow-hidden">
                      {img ? (
