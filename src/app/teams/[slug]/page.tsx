...
const plainDescription = team.description
    ...
    : `${team.level} team for ${team.ageGroup} ${team.gender} in ${team.city}, ${team.state}`;
    return ogMeta(
      ...
      <div className="max-w-[1100px] mx-auto px-6 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-5 lg:gap-6 items-start">
          ...
          <aside className="order-4 lg:order-none lg:[grid-row:span_10] flex flex-col gap-4">
            ...
            {/* Special Events */}
            <ListingEventsSidebar listingType="team" listingId={String(team.id)} listingSlug={slug} ownerId={ownerId} />
          </aside>
          ...
          <div className="order-1 lg:order-none lg:col-start-2 bg-white rounded-2xl overflow-hidden shadow-sm">
              ...
              <div className="mt-3 sm:mt-0 sm:flex-1 sm:min-w-0">
                ...
                {team.description && (
                  <div className="mb-0">
                    <InlineEditField ownerId={ownerId} listingType="team" listingId={team.id} field="description" value={team.description} tag="div" className="text-sm leading-relaxed text-gray-500 whitespace-pre-line [&>p]:mb-2 [&>p:last-child]:mb-0" multiline />
                  </div>
                )}
          ...
          <div className="order-6 lg:order-none lg:col-start-2 bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between mb-3.5">
                <h3 className="font-[family-name:var(--font-display)] text-lg sm:text-xl font-extrabold text-primary uppercase tracking-tight">Upcoming Events</h3>
                <EditSectionLink ownerId={ownerId} listingType="team" listingId={team.id} />
              </div>
          ...
          {similarTeams.length > 0 && (
              <div className="order-8 lg:order-none lg:col-start-2 bg-white rounded-2xl p-6 shadow-sm">
                <h3 className="font-[family-name:var(--font-display)] text-lg sm:text-xl font-extrabold text-primary uppercase tracking-tight mb-3.5">Similar Teams</h3>
