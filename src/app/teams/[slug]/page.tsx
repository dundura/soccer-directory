    ...
    <>
      <div className="bg-primary text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <a href="/teams" className="text-white/50 text-sm hover:text-white transition-colors mb-4 inline-block">&larr; All Teams</a>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-white/60 text-lg">
                {club ? <a href={`/clubs/${club.slug}`} className="hover:text-white transition-colors">{club.name}</a> : team.clubName} &middot; {team.city}, {team.state}
              </p>
            </div>
