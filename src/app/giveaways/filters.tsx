    ...
    <>
      <div className="bg-primary text-white py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-[family-name:var(--font-display)] text-3xl md:text-4xl font-bold mb-3">Free Giveaways</h1>
          <p className="text-white/70 max-w-2xl text-lg">Browse free soccer giveaways from the community.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {sorted.length === 0 ? (
          <EmptyState message="No giveaways found. Check back soon!" />
        ) : (
          <>
