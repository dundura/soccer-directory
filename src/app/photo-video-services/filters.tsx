  ...
  return (
    <>
      ...
      <div className="relative bg-primary overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 text-center">
          ...
          <p className="text-white/60 text-base md:text-lg max-w-2xl mx-auto mb-10">
            Find soccer photographers and videographers.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        {sorted.length === 0 ? (
          <EmptyState message="No photo & video services match your filters." />
        ) : (
          <>
            {/* ====== FEATURED CARDS ====== */}
              ...
              <div className="mb-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {topCards.map((service) => (
                    <ListingCard
                      key={service.id}
                      href={`/photo-video-services/${service.slug}`}
                      title={service.name}
                      subtitle={`by ${service.providerName} · ${service.city}, ${service.state}`}
                      image={service.logo || service.imageUrl || undefined}
                      badges={[
            ...
            <div className="space-y-3">
              {visibleNonFeatured.map((service) => {
                const img = service.logo || service.imageUrl;
                return (
                  <a
                    key={service.id}
                    href={`/photo-video-services/${service.slug}`}
