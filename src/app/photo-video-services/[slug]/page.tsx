          ...
          <div className="p-6 md:p-8">
            <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
              <div>
                ...
                <InlineEditField ownerId={ownerId} listingType="photovideo" listingId={service.id} field="name" value={service.name} tag="h1" className="text-2xl md:text-3xl font-extrabold text-primary leading-tight tracking-tight" />
                {service.tagline && (
