  ...
  const sidebarContent = (
    <>
      ...
      <div className="bg-white rounded-2xl overflow-hidden shadow-sm">
        <ClickableImage src={camp.teamPhoto || DEFAULT_SIDEBAR_PHOTO} alt={camp.name} className="w-full min-h-[150px] max-h-[280px] object-contain bg-surface block p-2" style={{ objectPosition: `center ${imgPos}%` }} />
