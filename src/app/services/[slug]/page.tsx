      ...
      <div className="max-w-4xl mx-auto px-6 pb-16">
        <div className="bg-white rounded-2xl overflow-hidden shadow-sm">
          ...
          <div className="p-6 md:p-8">
            ...
            {service.description && (
              <div className="mb-6">
                <InlineEditField ownerId={ownerId} listingType="service" listingId={service.id} field="description" value={service.description} tag="div" className="text-gray-600 leading-relaxed whitespace-pre-line [&>p]:mb-2 [&>p:last-child]:mb-0" multiline />
              </div>
            )}
