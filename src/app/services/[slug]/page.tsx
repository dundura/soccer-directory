  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-16">
          ...
          <div className="p-6 md:p-8">
            <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
              <div>
                ...
                <InlineEditField ownerId={ownerId} listingType="service" listingId={service.id} field="name" value={service.name} tag="h1" className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-primary uppercase leading-tight tracking-tight" />
                {service.tagline && (
            ...
            {service.description && (
              <div className="mb-6">
                <InlineEditField ownerId={ownerId} listingType="service" listingId={service.id} field="description" value={service.description} tag="div" className="text-gray-600 leading-relaxed [&>p]:mb-3 [&>p:last-child]:mb-0 [&>p:empty]:hidden" multiline />
              </div>
            )}
            ...
            {service.aboutAuthor && (
              <div className="border-t border-border pt-6 mt-6">
                ...
                <InlineEditField ownerId={ownerId} listingType="service" listingId={service.id} field="aboutAuthor" value={service.aboutAuthor} tag="div" className="text-gray-600 leading-relaxed [&>p]:mb-3 [&>p:last-child]:mb-0 [&>p:empty]:hidden" multiline />
              </div>
            )}
        ...
        {/* Events */}
        <ListingEventsSection listingType="service" listingId={service.id} listingSlug={slug} ownerId={ownerId} />
