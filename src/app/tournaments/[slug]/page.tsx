      ...
      <div className="max-w-[1100px] mx-auto px-6 pb-16">
        <div className="grid lg:grid-cols-[280px_1fr] gap-6 items-start">
          ...
          <div className="flex flex-col gap-5 lg:col-start-2 lg:row-start-1">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm">
              ...
              <div className="p-7">
                ...
                />
                <div>
                  <InlineEditField ownerId={ownerId} listingType="tournament" listingId={tournament.id} field="name" value={tournament.name} tag="h1" className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-primary uppercase leading-tight tracking-tight" />
                  {tournament.tagline && (
          ...
          <aside className="flex flex-col gap-4 lg:row-start-1 lg:row-span-3">
              ...
              <div className="bg-white rounded-2xl p-[18px] shadow-sm space-y-3.5">
                ...
                {tournament.email && (
                  <div>
                    ...
                    <a href={`/contact/tournament/${slug}`} className="text-sm font-bold text-accent-hover hover:underline">Contact</a>
                  </div>
                )}
              </div>
            )}
            ...
            {/* Special Events */}
            <ListingEventsSidebar listingType="tournament" listingId={String(tournament.id)} listingSlug={slug} ownerId={ownerId} />
          </aside>
          ...
          <main className="flex flex-col gap-5 lg:col-start-2">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className={`grid grid-cols-2 gap-2.5 ${videoUrl ? "mb-4" : ""}`}>
                <PhotoGrid photos={tournamentPhotos} alt="Tournament photo" />
              </div>
