        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          <div className="relative rounded-2xl overflow-hidden h-48 md:h-64">
            ...
            <div className="absolute bottom-0 left-0 p-6">
              ...
              {page.tagline && (
                <InlineEditField ownerId={ownerId} listingType="tiktokpage" listingId={page.id} field="tagline" value={page.tagline} tag="p" className="text-white/80 text-sm font-medium" />
              )}
