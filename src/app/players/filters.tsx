                  ...
                  {player.socialMedia && (player.socialMedia.instagram || player.socialMedia.youtube || player.socialMedia.facebook) && (
                    <div className="flex items-center justify-center gap-2 mb-3">
                      ...
                      {player.socialMedia.facebook && (
                        <a href={player.socialMedia.facebook.startsWith("http") ? player.socialMedia.facebook : `https://facebook.com/${player.socialMedia.facebook}`} target="_blank" rel="noopener" title="Facebook" className="w-7 h-7 rounded-md bg-[#1877F2] flex items-center justify-center text-white hover:opacity-80 transition-opacity" onClick={(e) => e.stopPropagation()}>
