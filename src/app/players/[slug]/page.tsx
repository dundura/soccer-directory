        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-6">
          <div className="grid grid-cols-1 md:grid-cols-[380px_1fr] gap-0">
            ...
            <div className="p-6 md:p-8 flex flex-col relative">
              ...
              {(player.description || player.lookingFor || (player.socialMedia && (player.socialMedia.instagram || player.socialMedia.youtube || player.socialMedia.facebook))) && (
                <div className="mt-5 pt-5 border-t border-border">
                  ...
                  {player.socialMedia && (player.socialMedia.instagram || player.socialMedia.youtube || player.socialMedia.facebook) && (
                    <div className="flex items-center gap-3 mt-4 pt-4 border-t border-border">
                      ...
                      <div className="flex gap-2">
                        ...
                        {player.socialMedia.facebook && (
                          <a href={player.socialMedia.facebook.startsWith("http") ? player.socialMedia.facebook : `https://facebook.com/${player.socialMedia.facebook}`} target="_blank" rel="noopener" title="Facebook" className="w-9 h-9 rounded-lg bg-[#1877F2] flex items-center justify-center text-white hover:opacity-80 transition-opacity">
