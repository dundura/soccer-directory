    ...
    <>
      ...
      <FilterBar
        filters={[
          ...
          { label: "All Age Groups", options: ageGroups, value: ageGroup, onChange: setAgeGroup },
          { label: "All Genders", options: ["Boys", "Girls", "Coed", "Men", "Women"], value: gender, onChange: setGender },
