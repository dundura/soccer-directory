...
export async function GET(req: Request) {
  ...
  try {
    ...
    await updateClubReviewStatus(token, "approved");
    return new Response(`<html><body style="font-family:sans-serif;text-align:center;padding:40px;"><h1 style="color:#22c55e;">Review Approved!</h1><p>The review is now visible on the Club Reviews page.</p><a href="https://www.soccer-near-me.com/club-reviews" style="display:inline-block;margin-top:20px;padding:12px 24px;background:#0F3154;color:white;text-decoration:none;border-radius:8px;">View Club Reviews</a></body></html>`, { headers: { "Content-Type": "text/html" } });
  } catch {
