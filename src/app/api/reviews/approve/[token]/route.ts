...
export async function GET(_req: Request, { params }: Props) {
  ...
  try {
    ...
    await updateReviewStatus(token, "approved");
    return new Response(`<html><body style="font-family:sans-serif;text-align:center;padding:40px;"><h1 style="color:#22c55e;">Review Approved!</h1><p>The review is now visible on the listing page.</p><a href="https://www.soccer-near-me.com" style="display:inline-block;margin-top:20px;padding:12px 24px;background:#0F3154;color:white;text-decoration:none;border-radius:8px;">Back to Soccer Near Me</a></body></html>`, { headers: { "Content-Type": "text/html" } });
  } catch {
