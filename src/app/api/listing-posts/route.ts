...
const VALID_TYPES = ["club", "team", "trainer", "recruiter", "futsal", "camp", "specialevent", "tryout", "tournament", "player", "blog", "fbgroup", "instagrampage", "tiktokpage", "podcast", "youtube", "service", "trainingapp", "ebook", "giveaway", "guest", "trip", "marketplace", "fundraiser", "soccerbook", "photovideo", "scrimmage"];
