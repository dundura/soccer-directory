        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-[280px] shrink-0 space-y-6">
            <div className="bg-white rounded-2xl border border-border overflow-hidden">
              <img src={sidebarImage} alt={item.name} className="w-full h-48 object-cover" />
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Special Offer */}
            {(item.announcementHeading || item.announcementText || item.announcementImage) && (
              <div className="bg-white rounded-2xl border border-border p-6 md:p-8 mb-6">
                <AnnouncementSection
                  heading={item.announcementHeading}
                  text={item.announcementText}
                  image={item.announcementImage}
                  ctaUrl={item.announcementCtaUrl}
                  ctaLabel={item.announcementCta || "Learn More →"}
                />
              </div>
            )}
