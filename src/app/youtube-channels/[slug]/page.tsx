        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          {(channel.description || channel.channelUrl || channel.subscribeUrl) && (
            <div className="bg-white rounded-2xl border border-border p-6">
              ...
              {channel.description && (
                <InlineEditField ownerId={ownerId} listingType="youtube" listingId={channel.id} field="description" value={channel.description} tag="div" className="text-sm leading-relaxed text-gray-500 whitespace-pre-line [&>p]:mb-2 [&>p:last-child]:mb-0" multiline />
              )}
