  ...
  return (
    <>
      ...
      <div className="bg-primary text-white py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/70 max-w-2xl text-lg mb-8">
            Discover YouTube channels covering soccer skills, coaching, match analysis, and more.
          </p>
          <div className="bg-white rounded-2xl shadow-lg p-2 flex flex-col sm:flex-row gap-2">
            <input
              ...
              placeholder="Search by channel name, creator, or topic..."
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        {sorted.length === 0 ? (
          <EmptyState message="No YouTube channels match your filters. Try broadening your search." />
        ) : (
              ...
              >
                ...
                <div className="flex gap-4 md:gap-6">
                  <div className="shrink-0">
                    <PlayerAvatar
                      src={channel.teamPhoto || channel.logo}
                      name={channel.name}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap gap-1.5 mb-2">
                      <Badge variant="blue">{channel.category}</Badge>
                    </div>
                    ...
                    <p className="text-muted text-sm mb-2">
                      Created by {channel.creatorName} &middot; {channel.city}, {channel.state}
                    </p>
                    {channel.description && (
