  ...
  const sidebarContent = (
    <>
      ...
      <div className="bg-white rounded-2xl overflow-hidden shadow-sm">
        <ClickableImage src={recruiter.previewImage || recruiter.teamPhoto || DEFAULT_SIDEBAR_PHOTO} alt={recruiter.name} className="w-full min-h-[150px] max-h-[280px] object-contain bg-surface block p-2" style={{ objectPosition: `center ${imgPos}%` }} />
      ...
      <div className="max-w-[1100px] mx-auto px-6 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-5 lg:gap-6 items-start">
          ...
          <aside className="hidden lg:flex flex-col gap-4">
            ...
            {/* Special Events */}
            <ListingEventsSidebar listingType="recruiter" listingId={recruiter.id} listingSlug={slug} ownerId={ownerId} />
          </aside>
              ...
              <div className="p-5 sm:p-7">
                ...
                <div>
                  ...
                  {recruiter.description && (
                    <div className="mb-0">
                      <InlineEditField ownerId={ownerId} listingType="recruiter" listingId={recruiter.id} field="description" value={recruiter.description} tag="div" className="text-sm leading-relaxed text-gray-500 whitespace-pre-line [&>p]:mb-2 [&>p:last-child]:mb-0" multiline />
                    </div>
                  )}
