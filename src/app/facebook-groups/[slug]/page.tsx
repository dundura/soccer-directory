        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          <div className="relative rounded-2xl overflow-hidden h-48 md:h-64">
            ...
            <div className="absolute bottom-0 left-0 p-6">
              <InlineEditField ownerId={ownerId} listingType="fbgroup" listingId={group.id} field="name" value={group.name} tag="h1" className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white uppercase leading-tight tracking-tight drop-shadow-lg" />
              {group.tagline && (
          ...
          {(group.description || group.groupUrl) && (
            <div className="bg-white rounded-2xl border border-border p-6">
              ...
              {group.description && (
                <InlineEditField ownerId={ownerId} listingType="fbgroup" listingId={group.id} field="description" value={group.description} tag="div" className="text-sm leading-relaxed text-gray-500 whitespace-pre-line [&>p]:mb-2 [&>p:last-child]:mb-0" multiline />
              )}
              {group.groupUrl && (
                <a
