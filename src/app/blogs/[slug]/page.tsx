      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <aside className="md:w-72 shrink-0 space-y-5">
          ...
          {ownerId && <ManageListingButton listingType="blog" listingId={blog.id} ownerId={ownerId} />}
            ...
            {/* Special Events */}
            <ListingEventsSidebar listingType="blog" listingId={blog.id} listingSlug={slug} ownerId={ownerId} />
          </aside>
        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          <div className="relative rounded-2xl overflow-hidden h-48 md:h-64">
            ...
            <div className="absolute bottom-0 left-0 p-6">
              <InlineEditField ownerId={ownerId} listingType="blog" listingId={blog.id} field="name" value={blog.name} tag="h1" className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white uppercase leading-tight tracking-tight drop-shadow-lg" />
              {blog.tagline && (
          ...
          {(blog.description || blog.website || blog.subscribeUrl) && (
            <div className="bg-white rounded-2xl border border-border p-6">
              ...
              {blog.description && (
                <InlineEditField ownerId={ownerId} listingType="blog" listingId={blog.id} field="description" value={blog.description} tag="div" className="text-sm leading-relaxed text-gray-500 whitespace-pre-line [&>p]:mb-2 [&>p:last-child]:mb-0" multiline />
              )}
