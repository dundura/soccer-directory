...
async function seed() {
  ...
  try {
    await sql.query("ALTER TABLE tournaments ADD COLUMN IF NOT EXISTS region TEXT NOT NULL DEFAULT 'US'");
    console.log("Added region column to tournaments.");
  ...
  const tournaments = [
    { id: "tn1", slug: "jefferson-cup-2026", name: "Jefferson Cup 2026", organizer: "Richmond Strikers", city: "Richmond", state: "VA", dates: "Mar 14–16, 2026", age_groups: "U9–U19", gender: "Boys & Girls", level: "Open / ECNL / MLS Next", entry_fee: "$1,200/team", format: "11v11", description: "One of the most prestigious youth soccer tournaments on the East Coast. Over 1,000 teams competing across multiple age groups and levels.", registration_url: "https://jeffersoncup.com", region: "US", featured: true },
    { id: "tn2", slug: "disney-soccer-showcase-2026", name: "Disney Soccer Showcase 2026", organizer: "Disney Sports", city: "Orlando", state: "FL", dates: "Mar 20–23, 2026", age_groups: "U10–U19", gender: "Boys & Girls", level: "Open / Premier", entry_fee: "$1,400/team", format: "11v11", description: "Play at ESPN Wide World of Sports Complex at Walt Disney World. A premier showcase event with college coach attendance.", registration_url: "https://disneysports.com/soccer", region: "US", featured: true },
    { id: "tn3", slug: "carolina-cup-spring-2026", name: "Carolina Cup Spring Classic", organizer: "CESA", city: "Charlotte", state: "NC", dates: "Apr 12–13, 2026", age_groups: "U8–U15", gender: "Boys & Girls", level: "Recreational / Competitive", entry_fee: "$600/team", format: "7v7 / 9v9 / 11v11", description: "Charlotte's premier spring tournament for recreational and competitive teams. Age-appropriate formats with professional referees.", registration_url: "https://cesasoccer.com/tournaments", region: "US", featured: true },
    { id: "tn4", slug: "ecnl-southeast-conference-event", name: "ECNL Southeast Conference Event", organizer: "ECNL", city: "Greensboro", state: "NC", dates: "May 3–4, 2026", age_groups: "U13–U17", gender: "Girls", level: "ECNL", entry_fee: "Included in ECNL fees", format: "11v11", description: "Official ECNL conference event for Southeast conference teams. Heavy college coach attendance expected.", region: "US", featured: false },
    { id: "tn5", slug: "rock-hill-memorial-day-classic", name: "Rock Hill Memorial Day Classic", organizer: "Carolina Rapids", city: "Rock Hill", state: "SC", dates: "May 24–25, 2026", age_groups: "U8–U18", gender: "Boys & Girls", level: "Open", entry_fee: "$500/team", format: "7v7 / 9v9 / 11v11", description: "Annual Memorial Day weekend tournament with teams from across the Southeast. Great competition and a fun holiday weekend atmosphere.", region: "US", featured: false },
    { id: "tn6", slug: "gothia-cup-2026", name: "Gothia Cup 2026", organizer: "BK Häcken", city: "Gothenburg", state: "Sweden", dates: "Jul 13–19, 2026", age_groups: "U11–U18", gender: "Boys & Girls", level: "International Open", entry_fee: "€450/team", format: "11v11", description: "The world's largest youth football tournament. Over 1,700 teams from 80+ nations compete in Gothenburg, Sweden every summer.", registration_url: "https://gothiacup.com", region: "International", featured: true },
    { id: "tn7", slug: "dana-cup-2026", name: "Dana Cup 2026", organizer: "Hjørring IF", city: "Hjørring", state: "Denmark", dates: "Jul 20–25, 2026", age_groups: "U12–U19", gender: "Boys & Girls", level: "International Open", entry_fee: "€400/team", format: "11v11", description: "One of Europe's biggest youth tournaments with 1,000+ teams from 50+ countries. Outstanding facilities and cultural exchange.", registration_url: "https://danacup.com", region: "International", featured: true },
  ];
  for (const t of tournaments) {
    await sql`INSERT INTO tournaments (id, slug, name, organizer, city, state, dates, age_groups, gender, level, entry_fee, format, description, registration_url, region, featured, status) VALUES (${t.id}, ${t.slug}, ${t.name}, ${t.organizer}, ${t.city}, ${t.state}, ${t.dates}, ${t.age_groups}, ${t.gender}, ${t.level}, ${t.entry_fee}, ${t.format}, ${t.description}, ${t.registration_url || null}, ${t.region}, ${t.featured}, 'approved') ON CONFLICT (id) DO UPDATE SET region = ${t.region}`;
  }

  // ── Futsal Teams ──────────────────────────────────────────────
  console.log("Seeding futsal teams...");
  const futsalTeams = [
    { id: "ft1", slug: "charlotte-futsal-club-u14", name: "Charlotte Futsal Club U14", club_name: "Charlotte Futsal Club", city: "Charlotte", state: "NC", level: "Competitive", age_group: "U14", gender: "Boys", coach: "Rafael Costa", looking_for_players: true, positions_needed: "Pivot, Winger", season: "2025-2026", description: "Premier futsal team developing technical players in a fast-paced small-sided environment. Indoor training year-round.", format: "5v5", featured: true },
    { id: "ft2", slug: "triangle-futsal-academy-u12-girls", name: "Triangle Futsal Academy U12 Girls", club_name: "Triangle Futsal Academy", city: "Raleigh", state: "NC", level: "Competitive", age_group: "U12", gender: "Girls", coach: "Ana Souza", looking_for_players: true, positions_needed: "All positions", season: "2025-2026", description: "Building the next generation of creative female futsal players. Focus on quick decision-making and 1v1 skills.", format: "5v5", featured: true },
    { id: "ft3", slug: "greenville-futsal-united-adult", name: "Greenville Futsal United", club_name: null, city: "Greenville", state: "SC", level: "Premier", age_group: "Adult", gender: "Men", coach: "Diego Fernandez", looking_for_players: true, positions_needed: "Goalkeeper, Defender", season: "Year-Round", description: "Competitive adult futsal team competing in regional and national futsal leagues.", format: "5v5", featured: true },
    { id: "ft4", slug: "carolina-futsal-rec-u10", name: "Carolina Futsal Rec U10", club_name: "Carolina Futsal", city: "Charlotte", state: "NC", level: "Recreational", age_group: "U10", gender: "Coed", coach: "Mike Thompson", looking_for_players: true, positions_needed: "All positions", season: "2025-2026", description: "Fun, introductory futsal program for young players. Learn the basics of the game in a low-pressure environment.", format: "4v4", featured: false },
  ];
  for (const f of futsalTeams) {
    await sql`INSERT INTO futsal_teams (id, slug, name, club_name, city, state, level, age_group, gender, coach, looking_for_players, positions_needed, season, description, format, featured, status) VALUES (${f.id}, ${f.slug}, ${f.name}, ${f.club_name}, ${f.city}, ${f.state}, ${f.level}, ${f.age_group}, ${f.gender}, ${f.coach}, ${f.looking_for_players}, ${f.positions_needed}, ${f.season}, ${f.description}, ${f.format}, ${f.featured}, 'approved') ON CONFLICT (id) DO NOTHING`;
  }
